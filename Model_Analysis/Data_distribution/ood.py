"""
This script calculates the Jaccard similarity coefficient between two sets of embeddings and identifies out-of-distribution (OOD) samples based on cosine similarity.
