"""
This script performs evaluation of tasks from three models by comparing predicted labels against true labels in respective datasets. The script includes functionalities for generating detailed evaluation metrics
